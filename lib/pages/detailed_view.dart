...
class _DetailedViewState extends State<DetailedView> {
  ...
  void _saveNote(String? originalTitle, String noteTitle, String noteBody) {
    ...
    final String? oldKey = originalTitle != null ? 'note_${widget.title}_$originalTitle' : null;
    ...
    if (oldKey != null && oldKey != newKey && (_prefs?.containsKey(oldKey) ?? false)) {
  ...
  void _addOrEditNote({String? originalTitle, String? noteTitle, String? noteBody}) async {
    ...
    if (result != null) {
      _saveNote(result['originalTitle'] as String?, result['title'] as String, result['body'] as String);
    }
  }
...
class NoteEditor extends StatelessWidget {
  ...
  NoteEditor({Key? key, this.originalTitle, this.title, this.body}) : super(key: key);
